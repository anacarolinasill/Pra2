...
public class Eventos {
    ...
    @NonNull
    @ColumnInfo(name = "EventosId")
    private int mId;

    @Nullable
    @ColumnInfo(name = "EventosTitle")
    private String mTitle;

    private String mEventos;

    public TvSerie (@Nullable String Local, String Descrição , int score, String creationDate) {
        mData = local;
    ...
    public void set(String descrição) {
        mDescrição = descrição;
    }
